          ...
          <li>
            <a href='https://www.linkedin.com/in/samsjchi/' target='_blank'>
              <svg x="0px" y="0px" viewBox="0 0 41 41">
                ...
                <circle className="ring" fill="none" strokeMiterlimit="10" cx="20.5" cy="20.5" r="20"></circle>
                <path className="linkedin-mark mark" d="M430.117,261.543V420.56h-92.188V272.193c0-37.271-13.334-62.707-46.703-62.707
          ...
          <li>
            <a href='https://www.facebook.com/samsjchi' target='_blank'>
              <svg x="0px" y="0px" viewBox="0 0 41 41">
                ...
                <circle className="ring" fill="none" strokeMiterlimit="10" cx="20.5" cy="20.5" r="20"></circle>
                <path className="fb-mark mark" fillRule="evenodd" clipRule="evenodd" d="M24,13c0,0.9,0,2.4,0,2.4s-1.8-0.2-2.2,0.5c-0.2,0.4-0.1,1.5-0.1,2.2c0.8,0,1.6,0,2.4,0c-0.2,0.9-0.3,1.5-0.5,2.3c-0.7,0-1.9,0-1.9,0V28c0,0-2.2,0-3.3,0c0-2.3,0-5,0-7.5c-0.5,0-0.9,0-1.4,0c0-0.9,0-1.5,0-2.4c0.5,0,0.9,0,1.4,0c0.1-1.7,0.1-3.4,1-4.3C20.3,12.9,21.2,13,24,13z"></path>
              </svg>
            </a>
          </li>
          <li>
