          ...
          <li>
            <a href='https://github.com/samsjchi' target='_blank'>
              <svg x="0px" y="0px" viewBox="0 0 41 41">
                <title>GitHub</title>
                <circle className="ring" fill="none" strokeMiterlimit="10" cx="20.5" cy="20.5" r="20"></circle>
          ...
          <li>
            <a href='https://www.linkedin.com/in/samsjchi/' target='_blank'>
              <svg x="0px" y="0px" viewBox="0 0 41 41">
                ...
                <circle className="ring" fill="none" strokeMiterlimit="10" cx="20.5" cy="20.5" r="20"></circle>
                <path className="linkedin-icon icon" d="M430.117,261.543V420.56h-92.188V272.193c0-37.271-13.334-62.707-46.703-62.707
